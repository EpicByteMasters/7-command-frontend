...
// 			(option) => option.key !== competenceOption.key
// 		);

// 		setCompetenceValue(
// 			makeInputValue(filtered.map((option) => getCompetitionOptionName(option)))
// 		);
// 	};
...
// 						placeholder="Начните вводить название"
// 						disabled={
// 							!competenceOptionList.length || (isExecutive ? false : true)
// 						}
// 					></InputAutocomplete>
// 				</div>
