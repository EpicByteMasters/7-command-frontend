  ...
  return (
    <aside className={styles.aside}>
      <nav className={styles.navtab} id="#nav">
        <BackButton className={styles.btnBack} isExecutive={isExecutive} isEmployee={isEmployee} isMentor={isMentor} />
        <ul className={styles.list}>
          <li className={styles.item}>
            <NavLink
              className={({ isActive }) => [isActive ? styles.active : '', styles.link].join(' ')}
              to={roleUrl[1].url}
              replace
            >
              <RocketMIcon fill="currentColor" className={styles.icon}></RocketMIcon>
              Мой план развития
            </NavLink>
          </li>
          ...
          {isExecutive ? (
            <li className={styles.item}>
              <NavLink
                ...
                replace
              >
                <TwoUsersMIcon fill="currentColor" className={styles.icon}></TwoUsersMIcon>
          ...
          {isMentor ? (
            <li className={styles.item}>
              <NavLink
                ...
                replace
              >
                <UserStarMIcon fill="currentColor" className={styles.icon}></UserStarMIcon>
                Менторство
              </NavLink>
            </li>
          ) : null}
