...
const isNotCompletedIpr = (status?: string) => status === IprStatusDoc.NotCompleted;
const isCanceledIpr = (status?: string) => status === IprStatusDoc.Canceled;
const isNoIprIpr = (status?: string) => status === IprStatusDoc.NoIpr;

export { isDraftIpr, isInProgressIpr, isCompletedIpr, isNotCompletedIpr, isCanceledIpr, isNoIprIpr };
